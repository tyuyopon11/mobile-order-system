...
export default function ShopManagerControls({ memberId, currentShopId, isActive, shops }: { memberId: string; currentShopId: string | null; isActive: boolean; shops: ShopOption[] }) {
  ...
  return <div className="mt-6 grid gap-6 lg:grid-cols-2">
    ...
    <section className="rounded-2xl border border-stone-200 bg-white p-6">
      ...
      <p className="mt-2 text-sm leading-6 text-stone-500">利用停止するとVendor Portalへアクセスできなくなります。</p>
