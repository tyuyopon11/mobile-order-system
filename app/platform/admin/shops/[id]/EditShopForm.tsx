      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <input
            ...
            maxLength={200}
            defaultValue={shop.short_description ?? ""}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              min={1}
              required
              defaultValue={shop.order_cutoff_hours ?? 24}
              disabled={isPending}
              className={inputClass}
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-5">
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" name="orderingEnabled" defaultChecked={shop.ordering_enabled} />
              注文受付ON
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" name="acceptsTuesday" defaultChecked={shop.accepts_tuesday} />
              火曜競り
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" name="acceptsSaturday" defaultChecked={shop.accepts_saturday} />
              土曜競り
            </label>
          </div>
          <div>
      ...
      <div className="grid gap-5 sm:grid-cols-[180px_1fr]">
        <div>
          ...
          <input
            ...
            max={9999}
            step={1}
            defaultValue={shop.display_order}
            disabled={isPending}
            className={inputClass}
          />
